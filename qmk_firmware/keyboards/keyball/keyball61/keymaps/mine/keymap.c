...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_universal(
    ...
    _______, KC_PSLS, KC_7 , KC_8  , KC_9   , KC_PPLS,                   _______, _______, KC_LBRC, KC_RBRC, KC_PSCR, KC_F12 ,
    _______, _______, KC_4 , KC_5  , KC_6   , KC_PMNS,                   KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, _______, _______,
    _______, _______, KC_1 , KC_2  , KC_3   , KC_PENT, KC_PAST, _______, _______, _______, _______, _______, _______, _______,
  ...
  [2] = LAYOUT_universal(
    ...
    _______, KC_Q   , KC_W   , KC_E        , KC_R   , KC_T   ,                         CPI_D1K      , CPI_D100     , CPI_I100, CPI_I1K , SCRL_DVI, KC_MINS,
    _______, _______, KC_S   , KC_VOLD     , KC_VOLU, KC_G   ,                         KC_NO        , KC_BTN1      , SCRL_MO , KC_BTN2 , SCRL_DVD, _______,
